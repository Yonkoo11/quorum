# Benchmark — the eight lenses on DeFiVulnLabs

Run 2026-09-16 · corpus commit `f61f6ee` · 57 files scanned · 10 targets · quorum threshold 2 · `python bench/run.py <corpus> --labels bench/labels/defivulnlabs.json`
...
| accounting-mismatch | 0 | 12 | 0 | 0% | n/a | **0** | 0 | **n/a** | **n/a** |
| **all** | 10 | 110 | 5 | 5% | 50% | **8** | 5 | **62%** | **50%** |
...
Candidates held back by the rule (one lens only): 102, of which on a target: 0.
