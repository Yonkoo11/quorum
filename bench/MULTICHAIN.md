...
Run 2026-09-13 (fetch) and re-run 2026-09-19 with the nine lenses (the swarm lines below) · `quorum fetch --chain <name> <address>` · Blockscout v2 API on each chain · no API key, no RPC, no token.
...
scanned 45 lens-units | confirmed 0 | recalled 0 | candidates 29 | suppressed 0 | duplicate work avoided 0
