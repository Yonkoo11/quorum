...
- **Tests:** pytest, 28 tests, no chain access needed (the chain is mocked where it matters).
...
tests/           # 28 tests: test_quorum.py (the swarm) and test_token.py (the token boundary)
