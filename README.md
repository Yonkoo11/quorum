...
- **Tests:** pytest, 37 tests, no chain access needed (the chain is mocked where it matters).
...
tests/           # 37 tests: test_quorum.py (the swarm) and test_token.py (the token boundary)
