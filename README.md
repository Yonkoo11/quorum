...
- **Tests:** pytest, 71 tests, no chain access needed (the chain is mocked where it matters).
...
tests/           # 71 tests: test_quorum.py (the swarm), test_token.py (the token boundary), test_targets.py (what an explorer may do), test_diary.py (the diary)
